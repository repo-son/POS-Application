...
Public Class Category
    ...
    Private Sub Category_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ToolTip2.SetToolTip(Button1, "Add Category")
    End Sub
    ...
    Public Sub LoadData()
        ...
        While dr.Read
            i += 1
            DataGridView1.Rows.Add(dr.Item("id").ToString, i, dr.Item("category").ToString, "", "")

        End While
        dr.Close()
        con.Close()
        lblCount.Text = "Categories Count :" & DataGridView1.RowCount & ""
    End Sub
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        ElseIf colName = "Column5" Then
            If (MsgBox("Do you want to Delete Category from DataBase", vbYesNo) = vbYes) Then
                con.Open()
                cmd = New SqlCommand("delete from tblCategory where id like '" + id + "'", con)
                cmd.ExecuteNonQuery()
                con.Close()
                MsgBox("Category Deleted", vbInformation)
                LoadData()
            End If
        End If
    End Sub
    ...
    Private Sub DataGridView1_SelectionChanged(sender As Object, e As EventArgs) Handles DataGridView1.SelectionChanged
        ...
        category = DataGridView1.Item(2, i).Value
